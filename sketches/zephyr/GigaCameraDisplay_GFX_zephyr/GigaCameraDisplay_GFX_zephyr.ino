...
void writeRect8BPP(GigaDisplay_GFX *pdisp, int16_t x, int16_t y, const uint8_t bitmap[],
    ...
    int __maybe_unused display_width = 480;   // pdisp->WIDTH;
    int __maybe_unused display_height = 800;  //pdisp->HEIGHT;
...
void loop() {
    ...
    if (cam.grabFrame(fb, 3000) == 0) {
        ...
        if (display_time_count == 128) {
            ...
            Serial.print(" fps:");
            Serial.println((float)128000000.0 / float(display_time_sum), 2);
            display_time_sum = 0;
